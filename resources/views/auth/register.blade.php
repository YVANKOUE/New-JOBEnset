...
<div class="login-signup">
    ...
    <form class="form text-center" method="POST" action="{{ route('register') }}" id="register_form">
        ...
        <div class="form-group">
            <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('name') is-invalid @enderror" type="text"  id="name" name="name" value="{{ old('name') }}" placeholder="Name" required autocomplete="name" autofocus />
            @error('name')
        ...
        <div class="form-group">
            <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('name') is-invalid @enderror" type="text"  id="matricule" name="matricule" value="{{ old('matricule') }}" placeholder="matricule" required autocomplete="matricule" autofocus />
            @error('matricule')
             <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
             </span>
        ...
        @php
            $roles = DB::table('roles')->select('name','id')->where('name', '!=', 'administrator')->get();
        @endphp
        <div class="form-group">
