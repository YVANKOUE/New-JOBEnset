    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item item-bg active">
                <img class="d-block w-100 h-100" src="{{asset('assets/accueil.jpg')}}" alt="banner">
                <img class="d-block w-100 h-100" src="{{asset('assets/accueil.jpg')}}" alt="banner">
                            ...
                            <div class="text-center">
                                ...
                                <div class="inline-search-area ml-auto mr-auto isa-3">
                                    <div class="search-boxs">
                                        ...
                                        <div class="find">
                                            <button style="background-color: #ef1945; color:white;" class="btn button-theme btn-search btn-block b-radius">
