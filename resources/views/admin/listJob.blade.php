                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{route('ajouter.index')}}" class="btn btn-primary font-weight-bolder">
                                            ...
                                            <td>
                                                    <a href=""
                                                     ...
                                                     <form method="POST" style="display: inline-block" 
                                                        action="{{route('ajouter.destroy', $annonce->id)}}"
                                                        accept-charset="UTF-8" class="delete">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" href="#" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> <span
