...
<?php $route = (isset($r['as'])) ? $r['as'] : ''; ?>
 ...
 <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
    ...
    @can('user_freelens')
        ...
        <div class="form-group row">
            <label class="col-xl-3 col-lg-3 col-form-label">@lang('domain')</label>
            <div class="col-lg-9 col-xl-9">
                <div class="input-group input-group-solid input-group-lg">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                    ...
                    <input class="form-control form-control-solid form-control-lg" name="domain" id="domain" placeholder="domain" />
                </div>
            </div>
        </div>

        <div class="form-group row">
            <label class="col-xl-3 col-lg-3 col-form-label">@lang('Sous domain')</label>
            <div class="col-lg-9 col-xl-9">
                <div class="input-group input-group-solid input-group-lg">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                    ...
                    <input class="form-control form-control-solid form-control-lg" name="sous_domain" id="sous_domain" placeholder="sous domain" />
                </div>
            </div>
        </div>
    @endcan
