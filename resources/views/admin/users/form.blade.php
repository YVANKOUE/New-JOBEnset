 ...
 <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
    ...
    @can('user_freelens')
      ...
      <div class="form-group">
        <select name="sousdomains[]" id="example" class="form-control"  multiple="multiple" style="display: none;">
            <option value="" disabled selected>Choose sous domain</option>
            @foreach ($sous_domains as $sousdomain)
                <option value="{{$sousdomain->id}}">{{$sousdomain->name}}</option>
            @endforeach
