    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                @can('users_client')
                    <li class="menu-item menu-item-@if(Str::startsWith($route, 'roles'))active @endif" aria-haspopup="true">
                        <a href="{{route('ajouter.index')}}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="menu-text">@lang('Post a Jobs')</span>
                        </a>
                    </li>
                @endcan 
                @can('users_client')
                    <li class="menu-item menu-item-@if(Str::startsWith($route, 'roles'))active @endif" aria-haspopup="true">
                        <a href="{{route('ajouter.create')}}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="menu-text">@lang('List Jobs')</span>
                        </a>
                    </li>
                @endcan
                @can('user_freelens')
                    <li class="menu-item menu-item-@if(Str::startsWith($route, 'roles'))active @endif" aria-haspopup="true">
                        <a href="{{route('client.index')}}" class="menu-link">
                            ...
                            <span class="menu-text">@lang('Jobs')</span>
                        </a>
                    </li>
                @endcan 
            </ul>
